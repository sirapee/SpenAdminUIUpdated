...
@Component({
  selector: 'app-add-internal-wallet',
  templateUrl: './add-internal-wallet.component.html',
  styleUrls: ['./add-internal-wallet.component.css']
})
export class AddInternalWalletComponent {
  ...
  submit() {
    if (this.addForm.valid) {
      ...
      this.walletService.createInternalWallets(this.addForm.value).subscribe(
        (response: any) => {
